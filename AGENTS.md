...
This project is indexed by GitNexus as **restaurant besteltool** (1236 symbols, 1809 relationships, 31 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
